...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Kreirajte novu praksu') }}</div>
                    ...
                    <div class="card-body col-md-12">
                        <form method="POST" action="{{ route('internship.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="duration" class="form-control" type="number" min="1" name="duration" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="maximum_number" class="form-control" type="number" min="1" name="maximum_number" required>
                                </div>

                                <label for="work_hours" class="col-md-2 col-form-label text-md-right">{{ __('Radno vreme') }}</label>

                                <div class="col-md-4">
                                    <input id="work_hours" class="form-control"  name="work_hours" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea id="description" style="height:300px" class="form-control" name="description" required></textarea>
                                </div>
                            </div>
